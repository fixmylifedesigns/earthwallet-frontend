...
const KioskDashboard = () => {
  ...
  // API configuration
  const apiBaseUrl =
    import.meta.env.VITE_API_BASE_URL || "https://earthwalletapi.onrender.com";
  ...
  return (
    <div
      className={`bg-gradient-to-br from-green-400 to-blue-600 flex items-center justify-center p-2 text-black ${
    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-6xl h-[95vh] flex flex-col overflow-hidden">
        ...
        <div className="flex-1 p-6 flex flex-col justify-center overflow-y-auto">
          ...
          {currentScreen === "signin" && (
            <div className="text-center space-y-6">
              ...
              <div className="flex justify-center space-x-4 mt-4">
                {" "}
                <button
                  onClick={() => setCurrentScreen("KioskId")}
                  className="bg-green-600 hover:bg-green-700 active:bg-green-800 active:bg-gray-700 text-white text-lg font-bold py-3 px-8 rounded-xl shadow-lg transform active:scale-95 transition-all duration-100"
                >
                  Kiosk ID
                </button>
                <button
          ...
          {currentScreen === "QRCode" && (
            <div className="text-center space-y-4">
              <div className="space-y-4">
                {/* Kiosk ID Display */}
                {selectedDeviceId && !kioskId && (
                  <div className="max-w-4xl bg-gray-50 border-4 border-gray-300 rounded-xl py-4 px-8 mx-auto w-fit">
                    {" "}
                    <Scanner
                      classNames="max-w-4xl"
                      onDecode={(code) => console.log(code)}
                      ...
                      onScan={(result) => {
                        if (!result || !result[0] || !result[0].rawValue) {
                          console.error("No valid QR code detected");
                        } else {
                          setKioskId(result[0]?.rawValue);
          ...
          {currentScreen === "KioskId" && (
            <div className="text-center space-y-4">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">
                Enter Your Kiosk ID
              </h2>
              <p className="text-lg text-gray-600 mb-4">
                Your 8-character Kiosk ID can be found in your EarthWallet
                account
              </p>
            ...
            <div className="text-center space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                ...
                >
                  ...
                  <div className="text-lg bg-blue-400 bg-opacity-50 rounded-xl py-2 px-4">
                    5¢ per bottle
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="text-lg bg-gray-400 bg-opacity-50 rounded-xl py-2 px-4">
                    10¢ per can
                  </div>
                </button>
              </div>
            ...
            <div className="text-center space-y-6">
              ...
              <div className="bg-blue-50 border-4 border-blue-200 rounded-xl p-4 mb-6">
                <p className="text-lg text-blue-800">
                  <span className="font-bold">Instructions:</span> Insert items
                  one by one into the machine.
                  <br />
                  <span className="text-sm mt-1 block">
                    {isElectron
                      ? "(Hardware integration active)"
                      : "(Press SPACEBAR to simulate item detection)"}
                  </span>
                </p>
              </div>
          ...
          {currentScreen === "result" && (
            <div className="text-center space-y-6">
              ...
              <div className="bg-gray-50 rounded-2xl p-6 mb-6">
                <p className="text-xl text-gray-800 mb-4">{result?.message}</p>
                ...
                {result?.success && (
                  <div className="space-y-3">
                    ...
                    <div className="text-lg text-gray-500">
                      {itemCount}{" "}
                      {selectedMaterial === "plastic" ? "bottles" : "cans"}{" "}
                      recycled
                    </div>
                  </div>
                )}
        ...
        <div className="bg-gray-100 p-3 rounded-b-2xl text-center text-gray-600 flex-shrink-0">
          <div className="flex justify-between items-center">
            ...
            <div className="text-xs text-gray-500">
              {isElectron && <span>Kiosk Mode • </span>}
