...
const handleAuth = async (e) => {
  ...
  // Also add this initialization function after your Firebase config
  const initializeFirebaseForCapacitor = async () => {
    if (Capacitor.isNativePlatform()) {
      try {
        // Initialize Capacitor Firebase
        await FirebaseAuthentication.configure();
      } catch (error) {
        console.error("Firebase Capacitor initialization error:", error);
      }
    }
  };
  ...
  useEffect(() => {
    ...
    initializeFirebaseForCapacitor();
